...
Hence, a total of 5.25 bits per symbol is necessary to store all the references, with a 4GiB memory, when can then process references up to $\approx 8.2*10^{8}$ symbols.
\end{minipage}
