...
\chapter{Hardware Sequencial Implementation of the FM-Index} % Main chapter title
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.5]{Figures/fmindex_top.png}
